...
public class UIRegisterOAuth extends UIContainer {
    ...
    public static class CancelActionListener extends UIMaskWorkspace.CloseActionListener {
        ...
        public void execute(Event<UIComponent> event) throws Exception {
            ...
            UIMaskWorkspace mask = ui.getAncestorOfType(UIMaskWorkspace.class);
            if(mask != null) {
                super.execute(event);
            }
            ...
            authRegistry.removeAttributeOfClient(httpRequest, OAuthConstants.ATTRIBUTE_AUTHENTICATED_PORTAL_USER_DETECTED);
            ...
            if(mask == null) {
                String url = OAuthUtils.getURLToRedirectAfterLinkAccount(httpRequest, httpRequest.getSession());
                Util.getPortalRequestContext().getJavascriptManager().addJavascript("window.location = '" + url + "';");
            }
        }
    }
